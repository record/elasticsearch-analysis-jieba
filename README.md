...
**5.5.1**
```sh
./bin/plugin install https://github.com/kaorimatz/elasticsearch-analysis-jieba/releases/download/v5.5.1/elasticsearch-analysis-jieba-5.5.1-bin.zip
```
...
github-release upload \
    ...
    --repo elasticsearch-analysis-jieba \
    --tag v5.5.1 \
    --name elasticsearch-analysis-jieba-5.5.1-bin.zip \
    --file target/releases/elasticsearch-analysis-jieba-5.5.1-bin.zip

github-release upload \
    --user kaorimatz \
    --repo elasticsearch-analysis-jieba \
    --tag v5.5.1 \
    --name elasticsearch-analysis-jieba-5.5.1-bin.zip.sha1 \
    --file target/releases/elasticsearch-analysis-jieba-5.5.1-bin.zip.sha1
```
